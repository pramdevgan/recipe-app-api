...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            user=self.user,
            title='Sample recipe title',
            link='https://example.com/recipes.pdf',
            description='Sample recipe description'
        )
        payload = {
            'title': 'New recipe title',
            'link': 'https://example.com/new_recipes.pdf',
    ...
    def test_delete_other_users_recipe_error(self):
        """Test trying to delete another users recipe gives error message."""
        new_user = create_user(
            email='user2@example.com',
            password='testpass1123123'
        )
    ...
    def test_create_recipe_with_new_ingredients(self):
        """Testt creating a new recipe with new ingredients."""
        payload = {
            'title': 'Test Recipe',
            'time_minutes': 45,
            'price': Decimal('242'),
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        self.assertEqual(recipes.count(), 1)
        recipe = recipes.first()
        # print("Using Method", recipes.first())
        # print("Using Indexing", recipes[0])
        self.assertEqual(recipe.ingredients.count(), 2)
    ...
    def test_create_ingredient_on_update(self):
        """Test updating an ingredient on an existing"""
        recipe = create_recipe(user=self.user)
